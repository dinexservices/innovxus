        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6 md:space-y-8">
              <h2 className="text-red-600 font-bold uppercase tracking-widest text-sm md:text-base">Our Mission</h2>
              <h3 className="text-[clamp(2.5rem,6vw,4.5rem)] font-syncopate font-bold leading-tight">
                FUELING THE <span className="text-red-600 underline underline-offset-4 md:underline-offset-8">EXPERIENCE</span> ECONOMY
              </h3>
              ...
              <div className="flex gap-8 md:gap-12">
                <div>
                  <p className="text-4xl md:text-5xl font-syncopate font-bold text-red-600 mb-2">50+</p>
                  <p className="text-xs md:text-sm uppercase tracking-widest text-gray-500 font-bold">College Fests</p>
                </div>
                <div>
                  <p className="text-4xl md:text-5xl font-syncopate font-bold text-red-600 mb-2">200k</p>
                  <p className="text-xs md:text-sm uppercase tracking-widest text-gray-500 font-bold">Attendees</p>
                </div>
              </div>
            </div>
