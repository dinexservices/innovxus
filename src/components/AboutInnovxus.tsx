            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row gap-16 items-start">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <h3 className="text-4xl md:text-5xl font-syncopate font-bold text-black mb-8 leading-tight">
                    ...
                    <div className="lg:w-1/2 pt-8 lg:pt-0">
                        <div className="relative">
                            ...
                            <h3 className="text-3xl md:text-4xl font-syncopate font-bold text-black mb-8 relative z-10">
                                ROLE OF <span className="text-red-600">INNOVXUS</span>
                            </h3>

                            <div className="space-y-6 relative z-10">
                                {roles.map((role, idx) => (
                                    <div key={idx} className="flex items-center gap-6 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-red-600/30 hover:shadow-md transition-all duration-300 group">
